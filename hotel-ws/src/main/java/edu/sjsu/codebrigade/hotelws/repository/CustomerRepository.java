...
public interface CustomerRepository extends JpaRepository<Customer, Integer> {
    ...
    @Query(value = "UPDATE customer SET reward_points = :rewardPoints  WHERE email = :emailId",nativeQuery = true)
    int updateRewardPoints(@Param("rewardPoints")float rewardPoints, @Param("emailId")String emailId);
}
